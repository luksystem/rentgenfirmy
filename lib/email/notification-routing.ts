...
export const NOTIFICATION_ROUTING_CATEGORY_LABELS: Record<NotificationRoutingCategory, string> = {
  ...
  proces_dom: "Zakończenie etapu — proces DOM",
};
...
export const NOTIFICATION_ACTION_DEFINITIONS: NotificationActionDefinition[] = [
  ...
  {
    id: "stage_dom_1_uruchomienie",
    label: "Etap 1 — Uruchomienie projektu",
    description: "Ręczne podsumowanie zamknięcia etapu 1 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_1_uruchomienie",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_2_dane_projektowe",
    label: "Etap 2 — Zebranie danych projektowych",
    description: "Ręczne podsumowanie zamknięcia etapu 2 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_2_dane_projektowe",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_3_projektowanie",
    label: "Etap 3 — Projektowanie i akceptacja projektu",
    description: "Ręczne podsumowanie zamknięcia etapu 3 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_3_projektowanie",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_4_instalacja",
    label: "Etap 4 — Instalacja elektryczna i okablowanie",
    description: "Ręczne podsumowanie zamknięcia etapu 4 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_4_instalacja",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_5_koordynacja",
    label: "Etap 5 — Koordynacja przed montażem",
    description: "Ręczne podsumowanie zamknięcia etapu 5 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_5_koordynacja",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_6_prefabrykacja",
    label: "Etap 6 — Prefabrykacja rozdzielni",
    description: "Ręczne podsumowanie zamknięcia etapu 6 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_6_prefabrykacja",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_7_rozdzielnia",
    label: "Etap 7 — Dostawa i podłączenie rozdzielni",
    description: "Ręczne podsumowanie zamknięcia etapu 7 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_7_rozdzielnia",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_8_montaze",
    label: "Etap 8 — Montaże urządzeń",
    description: "Ręczne podsumowanie zamknięcia etapu 8 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_8_montaze",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_9_uruchomienie_testy",
    label: "Etap 9 — Uruchomienie, testy i przekazanie systemu",
    description: "Ręczne podsumowanie zamknięcia etapu 9 procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_9_uruchomienie_testy",
    defaults: { email: { client: false }, push: false, sms: false },
  },
  {
    id: "stage_dom_10_optymalizacja",
    label: "Etap 10 — Optymalizacja po zamieszkaniu",
    description: "Ręczne podsumowanie zamknięcia etapu 10 (koniec wdrożenia) procesu DOM dla inwestora — bez automatycznej wysyłki.",
    category: "proces_dom",
    emailAudiences: ["client"],
    supportsPush: false,
    supportsSms: false,
    emailTemplateKind: "stage_dom_10_optymalizacja",
    defaults: { email: { client: false }, push: false, sms: false },
  },
];
