  ...
  const samples: Array<Omit<ServiceRecord, "id" | "createdAt" | "updatedAt">> = [
    {
      ...
      rates: { ...base.rates },
      discounts: { percentDiscount: 0, specialDiscountPln: 0, vatRate: 0 },
    ...
    },
    {
      ...
      rates: { ...base.rates },
      discounts: { percentDiscount: 5, specialDiscountPln: 0, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 3,
    ...
    },
    {
      ...
      serviceType: "Pogwarancyjny",
      rates: { ...base.rates },
      discounts: { percentDiscount: 0, specialDiscountPln: 200, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        programmerHours: 6,
    ...
    },
    {
      ...
      rates: { ...base.rates },
      discounts: { percentDiscount: 0, specialDiscountPln: 0, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 4,
    ...
    },
    {
      ...
      serviceType: "Prace dodatkowe",
      rates: { ...base.rates },
      discounts: { percentDiscount: 10, specialDiscountPln: 0, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 6,
    ...
    },
    {
      ...
      serviceType: "Inne",
      rates: { ...base.rates },
      discounts: { percentDiscount: 0, specialDiscountPln: 150, vatRate: 8 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 8,
