  ...
  > = [
    {
      ...
      estimateDiscounts: { percentDiscount: 0, specialDiscountPln: 0, vatRate: 0 },
      actualDiscounts: { percentDiscount: 0, specialDiscountPln: 0, vatRate: 0 },
    ...
    },
    {
      ...
      clientId: null,
      detailedSettlement: false,
      estimateDiscounts: { percentDiscount: 5, specialDiscountPln: 0, vatRate: 23 },
      actualDiscounts: { percentDiscount: 5, specialDiscountPln: 0, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 3,
    ...
    },
    {
      ...
      clientId: null,
      detailedSettlement: false,
      estimateDiscounts: { percentDiscount: 0, specialDiscountPln: 200, vatRate: 23 },
      actualDiscounts: { percentDiscount: 0, specialDiscountPln: 200, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        programmerHours: 6,
    ...
    },
    {
      ...
      clientId: null,
      detailedSettlement: false,
      estimateDiscounts: { percentDiscount: 0, specialDiscountPln: 0, vatRate: 23 },
      actualDiscounts: { percentDiscount: 0, specialDiscountPln: 0, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 4,
    ...
    },
    {
      ...
      clientId: null,
      detailedSettlement: false,
      estimateDiscounts: { percentDiscount: 10, specialDiscountPln: 0, vatRate: 23 },
      actualDiscounts: { percentDiscount: 10, specialDiscountPln: 0, vatRate: 23 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 6,
    ...
    },
    {
      ...
      clientId: null,
      detailedSettlement: false,
      estimateDiscounts: { percentDiscount: 0, specialDiscountPln: 150, vatRate: 8 },
      actualDiscounts: { percentDiscount: 0, specialDiscountPln: 150, vatRate: 8 },
      zoneSettings: { ...base.zoneSettings },
      estimate: {
        ...emptyLineItems(),
        supervisionHours: 8,
