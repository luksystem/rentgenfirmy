  ...
  for (const staticItem of [...config.staticItems].sort((a, b) => a.position - b.position)) {
    appendUnique(
      ...
      seenKeys,
      {
        ...
        requireDocumentation: staticItem.requireDocumentation,
        documentationHint: staticItem.documentationHint,
      ...
      catalogItems.forEach((catalogItem, itemIndex) => {
        appendUnique(
          ...
          seenKeys,
          {
            ...
            requireDocumentation: catalogItem.requireDocumentation,
            documentationHint: catalogItem.documentationHint,
