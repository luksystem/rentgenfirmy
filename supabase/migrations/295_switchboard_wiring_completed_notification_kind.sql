-- Nowy kind powiadomienia: instalator oznaczył wpinanie rozdzielnicy jako zakończone, osoba
-- odpowiedzialna za etap dostaje o tym informację (push + w apce).
...
alter table user_notifications add constraint user_notifications_kind_check check (
  kind = any (array[
    ...
    'leave_substitution_proposed','switchboard_wiring_completed'
  ])
);
