-- Brakowalo template_item_id w wyjsciu - potrzebne w UI do wywolania updateProjectProcessCompletion
-- (kluczuje po template_item_id, nie po project_process_items.id). DROP wymagany bo zmiana listy
-- kolumn RETURNS TABLE.
