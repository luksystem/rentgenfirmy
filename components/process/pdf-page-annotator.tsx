  ...
  return (
    <div className={cn("grid gap-2", className)}>
      ...
      >
        ...
        <canvas
          ref={drawCanvasRef}
          className={cn("absolute inset-0 block w-full", readOnly ? "cursor-default" : "cursor-crosshair")}
      ...
      {!readOnly ? (
        <p className="text-center text-[11px] text-muted">
          Pisz/rysuj rysikiem lub palcem bezpośrednio na stronie — zapisuje się automatycznie.
        </p>
      ) : null}
    </div>
  );
